...
from samba.auth import system_session, AUTH_SESSION_INFO_DEFAULT_GROUPS
from samba.auth import AUTH_SESSION_INFO_AUTHENTICATED, AUTH_SESSION_INFO_SIMPLE_PRIVILEGES
